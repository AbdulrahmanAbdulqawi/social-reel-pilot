    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      ...
      <div className="container mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-24">
        <div className="text-center max-w-4xl mx-auto mb-16 sm:mb-20 animate-fade-in">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 sm:mb-8 bg-gradient-to-r from-primary via-primary-light to-primary-glow bg-clip-text text-transparent px-4 leading-tight">
            {t('dashboard.welcome')}
          </h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto mb-16 sm:mb-20">
          <div className="p-6 sm:p-8 border-2 rounded-2xl bg-gradient-to-br from-card to-card/50 hover:shadow-glow hover:border-primary/20 transition-all duration-300 hover:-translate-y-2 group">
            <div className="p-3 sm:p-4 bg-gradient-to-br from-primary/10 to-primary/5 rounded-xl w-fit mb-4 sm:mb-5 group-hover:scale-110 transition-transform">
              <Video className="w-6 h-6 sm:w-7 sm:h-7 text-primary" />
            </div>
            <h3 className="text-xl sm:text-2xl font-bold mb-3">{t('upload.title')}</h3>
          ...
          <div className="p-6 sm:p-8 border-2 rounded-2xl bg-gradient-to-br from-card to-card/50 hover:shadow-glow hover:border-primary/20 transition-all duration-300 hover:-translate-y-2 group">
            ...
            <h3 className="text-xl sm:text-2xl font-bold mb-3">{t('upload.schedule')}</h3>
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
              {t('dashboard.subtitle')}
            </p>
          </div>

          <div className="p-6 sm:p-8 border-2 rounded-2xl bg-gradient-to-br from-card to-card/50 hover:shadow-glow hover:border-primary/20 transition-all duration-300 hover:-translate-y-2 group sm:col-span-2 md:col-span-1">
            <div className="p-3 sm:p-4 bg-gradient-to-br from-primary/10 to-primary/5 rounded-xl w-fit mb-4 sm:mb-5 group-hover:scale-110 transition-transform">
              <BarChart3 className="w-6 h-6 sm:w-7 sm:h-7 text-primary" />
            </div>
            <h3 className="text-xl sm:text-2xl font-bold mb-3">{t('analytics.title')}</h3>
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
        ...
        {/* CTA Section */}
        <div className="text-center p-8 sm:p-12 border-2 border-primary/20 rounded-3xl bg-gradient-to-br from-primary/5 via-card to-card max-w-4xl mx-auto shadow-glow">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6 px-4 bg-gradient-to-r from-primary to-primary-light bg-clip-text text-transparent">
            {t('dashboard.welcome')}
          </h2>
        ...
        <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              <Button
                variant="link"
                className="text-sm text-muted-foreground hover:text-primary p-0 h-auto transition-colors"
